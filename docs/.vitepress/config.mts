...
export default defineConfig({
  ...
  vite: {
    plugins: [
      ...
      GitChangelog({
        // 填写在此处填写您的仓库链接
        repoURL: () => 'https://github.com/cunyu1943/blog',
      }),
  ...
  title: "村雨遥的博客",
  // 站点描述
  description: "「公众号：村雨遥」的大本营，公众号无法分享的内容你都可以在这里找到。",
  // 纯净链接
  cleanUrls: true,
  // 预演
  lang: 'zh-CN',
  ...
  themeConfig: {
    ...
    //编辑本页
    editLink: {
      pattern: 'https://github.com/cunyu1943/blog/edit/main/docs/:path', // 改成自己的仓库
      text: '我要纠错'
    },
    // 导航栏
    nav: nav,
    ...
    // 社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/cunyu1943/blog' },
